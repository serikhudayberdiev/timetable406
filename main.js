...
const scheduleData = {
    ...
    Friday: [
        [
            { subject: "Реализация мероприятий в рамках Рабочей программы воспитания (мероприятия по социально-воспитательной работе)", type: "Пр.", startWeek: 1, endWeek: 17, professor: "", room: "" }
        ],
        [
            { subject: "Реализация мероприятий в рамках Рабочей программы воспитания (мероприятия по социально-воспитательной работе)", type: "Пр.", startWeek: 1, endWeek: 17, professor: "", room: "" }
        ],
